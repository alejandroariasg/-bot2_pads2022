...
def on_command_start(message):
    ...
    bot.send_message(
        message.chat.id,
        "Hola, soy un \U0001FAE0, ¿cómo estás?",
        parse_mode="Markdown") 
...
def on_dividir(message):
    ...
    if oper2 == 0:
       respuesta = f"\U0001F92F	 El segundo dígito de la división debe ser difirente a 0"
    else:
        respuesta = f"\U0001F522 Resultado: {oper1 / oper2}"
